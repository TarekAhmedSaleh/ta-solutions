...
window.addEventListener('load', OnScrollCallback);  // Trigger the callback on page load
...
window.AnimateOnScroll = {
    ...
    Register: function (instance, divReference, pOffset) {
        ...
        // Trigger a check immediately after registration to handle elements already in view
        OnScrollCallback();
    },
}
